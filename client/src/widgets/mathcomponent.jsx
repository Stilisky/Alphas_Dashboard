...
import Maths from '../img/mats.png'
            ...
            <a href="#jg" class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                <div class="shadow p-4 rounded-lg bg-white flex flex-col items-center">
                    <div className='flex items-center justify-between'>
                        <img src={Maths} alt="joke" className='h-[50px]' />
                    </div>
                    <div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Nam deleniti at eveniet a delectus tempore soluta quis repudiandae sunt sequi consectetur est
                            quia rerum, laudantium, aut assumenda. Commodi, maxime dolorum!
                        </p>
                    </div>
